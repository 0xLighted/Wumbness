...
export default function PatientForm() {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Anonymous Toggle - Usually for registration, or quick test */}
      <button className="w-full bg-gray-100 hover:bg-gray-200 text-charcoal font-bold py-3 rounded-xl transition-colors">
        Connect Anonymously
      </button>
      ...
      <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <button
          type="submit"
          className="w-full transform transition-all duration-200 bg-sage hover:bg-[#8CA26E] text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl mt-2 active:scale-[0.98]"
        >
